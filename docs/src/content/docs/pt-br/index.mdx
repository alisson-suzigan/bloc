...
<SponsorsGrid sponsoredBy="Patrocinado com 💖 por" becomeASponsor="Seja um patrocinador"/>
...
<Card title="Fazer uma visita guiada" icon="star">
  Complete [os tutoriais oficiais](/pt-br/tutorials/flutter-counter) para aprender as práticas
  recomendadas e criar uma variedade de aplicativos diferentes desenvolvidos pelo Bloc.
</Card>

<Card title="Construir com Bloc" icon="laptop">
  Explore [amostras de aplicações](https://github.com/felangel/bloc/tree/master/examples)
  de alta qualidade e totalmente testadas, como contador, temporizador, lista infinita,
